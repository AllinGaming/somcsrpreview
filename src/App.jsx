...
export default function App() {
  ...
  const activeCount = active?.rows.length ?? 0;
          ...
          >
            <CardHeader className="module-header wc-header">
              ...
              <div className="module-actions">
                ...
                <Button type="button" onClick={copySheet}>
                  {copyStatus}
                </Button>
              </div>
            </CardHeader>
                              ...
                              <td className="cell-name">
                                <Tooltip>
                                  ...
                                  <TooltipContent>
                                    ...
                                    <TooltipBody>Open player in armory</TooltipBody>
                                  </TooltipContent>
                                </Tooltip>
                              </td>
                              <td className="cell-csr">
                                <Badge className={`csr-badge ${tier.className}`}>
                                  {row.value || "-"}
                                </Badge>
                              </td>
                            </tr>
